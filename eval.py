...
def plotresponse(opt, inputx, real, predicted, type, out_size):
    ...
    for frame in predicted:
        ...
        ax2 = inputx[i][["Applied voltage"]].plot(kind='line', linewidth=1.0, color='black')
        plt.xlabel("Time [msec]", fontsize=16)
        plt.ylabel("Applied voltage", fontsize=16)
        # plt.title(type + str(i))
...
def main():
    ...
    parser.add_argument('-savepath', type=str, default="Experiment1/GRU/4/Run3/")
